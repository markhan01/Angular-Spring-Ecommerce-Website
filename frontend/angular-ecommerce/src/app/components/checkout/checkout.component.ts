...
export class CheckoutComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    /* Code used before implementing Stripe API
  ...
  onSubmit() {
    ...
    // Mark all fields as touched to trigger error messages if form is invalid
    ...
    */
    ...
    // multiply by 100 since lowest demonination of USD is cents
    // must round due to javascript not having int values, whereas Java amount is in int
    ...
    if (!this.checkoutFormGroup.invalid && this.displayError.textContent === "") {
      ...
      // disable purchase button until after REST API is successfully called to prevent multiple button presses
  ...
  resetCart() {
    ...
    // prevents cart data from persisting after reloading after a successful purchase
